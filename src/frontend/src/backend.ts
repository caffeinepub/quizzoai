...
export class Backend implements backendInterface {
    ...
    async addTestHistory(arg0: TestHistory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTestHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTestHistory(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteTestHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTestHistory(): Promise<Array<TestHistory>> {
        if (this.processError) {
            try {
